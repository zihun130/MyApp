...
public class ClassifyDetailRecyclerAdapter extends RecyclerView.Adapter<ClassifyDetailRecyclerAdapter.ViewHolder> {
    private final Context context;
    private final List<ClassifyDetailBean.DataBean.ItemsBean> itemsBeans;

    public ClassifyDetailRecyclerAdapter(Context context, List<ClassifyDetailBean.DataBean.ItemsBean> itemsBeans) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ClassifyDetailBean.DataBean.ItemsBean itemsBean = itemsBeans.get(position);
